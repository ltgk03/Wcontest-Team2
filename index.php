...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-transparent">
    <div class="container-fluid">
      ...
      <a href="adminLogin.php"><span class="navbar-toggler-icon"></span></a>
    </div>
  </nav>
  ...
  <form action="userLogin.php" method="post" class="user-login">
    <fieldset>
      ...
      <?php if (isset($_GET['error'])) { ?>
        <p id="invalid" style="text-align: center; color: red; padding-top: 1%; margin: 0; font-size: 1.2rem"><?php echo $_GET['error']; ?></p>
      <?php } ?>
      <div style="display: flex; justify-content: center">
